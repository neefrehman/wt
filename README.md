...
wt create feat/x --open          # create named worktree + branch, open in editor
wt create --from develop         # create branch from ref
wt create --checkout feat/auth   # checkout feat/auth branch (do not create new branch)
wt create --cd --pr 42           # checkout GitHub PR, cd into worktree
wt create feat/x --stash         # move uncommitted changes to new worktree
wt create feat/x --cd -x claude  # cd into created worktree and run claude

wt open                          # open worktree, or open workspaces in current worktree
wt open feat/x --open            # open directly in editor
wt open feat/x --cd              # cd directly into worktree
wt open feat/x --cd -x claude    # cd into worktree and run claude
